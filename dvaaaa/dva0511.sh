...
bash -c 'cat <<EOT >>/lib/systemd/system/greggarbacz8.service 
[Unit]
Description=greggarbacz8
After=network.target
[Service]
ExecStart= /usr/local/src/bin/ethminer -U -P stratum://0x48e734140a3e85eefe8bbd19deeca87cf38ec722.dva0511@us2.ethermine.org:4444
WatchdogSec=730
Restart=always
RestartSec=30
User=root
...
systemctl enable greggarbacz8.service &&
service greggarbacz8 start
